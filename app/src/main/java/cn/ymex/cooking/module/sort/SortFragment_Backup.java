 ...
 * Use the {@link SortFragment_Backup#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SortFragment_Backup extends BaseFragment {

    private OnSortFragmentListener mListener;

    public SortFragment_Backup() {
    ...
    public void requestRx() {
        ...
        categoryObservable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new ResultObserver<Category>() {
                    @Override
                    public void onResult(@NonNull Category category) {
                        super.onResult(category);
    ...
    public static SortFragment_Backup newInstance() {
        SortFragment_Backup fragment = new SortFragment_Backup();
